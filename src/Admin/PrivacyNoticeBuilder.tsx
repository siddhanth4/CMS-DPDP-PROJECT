...
const DEFAULT_SECTIONS: NoticeSection[] = [
    {
        ...
        icon: "bi-building",
        placeholder: "Enter details about the organization acting as Data Fiduciary under the DPDP Act, 2023. Include registered name, address, and contact information.",
        required: true,
        content: "",
        enabled: true,
    },
    {
        ...
        icon: "bi-bullseye",
        placeholder: "Clearly describe the specific, explicit, and legitimate purposes for which personal data is collected and processed. Each purpose must be lawful under the DPDP Act.",
        required: true,
        content: "",
        enabled: true,
    },
    {
        ...
        icon: "bi-collection",
        placeholder: "List the types of personal data that will be collected (e.g., name, email, Aadhaar number, health data, financial data). Indicate if any sensitive personal data is included.",
        required: true,
        content: "",
        enabled: true,
    },
    {
        ...
        placeholder: "Specify the legal basis under Section 4 of the DPDP Act, 2023. E.g., Consent of the Data Principal, performance of a contract, compliance with legal obligation, etc.",
        required: true,
        content: "",
        enabled: true,
    },
    {
        ...
        placeholder: "Specify how long personal data will be retained and the criteria used to determine retention periods. Include data erasure obligations under Section 8(7) of the DPDP Act.",
        required: true,
        content: "",
        enabled: true,
    },
    {
        ...
        icon: "bi-share",
        placeholder: "Disclose if personal data is shared with Data Processors or third parties. Mention cross-border transfers if applicable and safeguards in place.",
        required: false,
        content: "",
        enabled: true,
    },
    {
        ...
        placeholder: "Describe the rights available under Chapter III of the DPDP Act: Right to Access, Right to Correction, Right to Erasure, Right to Grievance Redressal, Right to Nominate, and Right to Withdraw Consent.",
        required: true,
        content: "",
        enabled: true,
    },
    {
        ...
        placeholder: "Provide name, email, and contact details of the Data Protection Officer (if appointed) or the designated contact person for data protection queries.",
        required: false,
        content: "",
        enabled: false,
    },
    {
        ...
        icon: "bi-headset",
        placeholder: "Provide contact details of the Grievance Officer and the process to raise a complaint. Include escalation to the Data Protection Board of India if unresolved.",
        required: true,
        content: "",
        enabled: true,
    },
    {
        ...
        placeholder: "Explain how and when Data Principals will be notified of material changes to this privacy notice. Include the effective date mechanism.",
        required: false,
        content: "",
        enabled: true,
    },
...
const handleSave = async () => {
        try {
            ...
            // 👉 NEW: Check if backend returned a success code (assuming 101 is success)
            if (res && res.responseCode && res.responseCode !== 101) {
                alert(`Backend rejected the save: ${res.responseMessage}`);
                return; // Stop execution, don't show "Saved!"
            }
                    ...
                    <div className="panel-head p-3 d-flex flex-wrap gap-3 align-items-center justify-content-between">
                        <div>
                            ...
                            <div className="text-secondary small">
                                Create DPDP Act, 2023 compliant privacy notices · Linked to consent forms
                            </div>
                        </div>
